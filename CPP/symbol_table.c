...
// Data** createAttributes(char* attrName, int* attrCount) {
//     *attrCount = 1;  
//     Data** attrList = (Data**)malloc(sizeof(Data*) * (*attrCount));
...
// Data** addAttribute(Data** attrList, char* attrName, int* attrCount) {
//     (*attrCount)++;  
//     attrList = (Data**)realloc(attrList, sizeof(Data*) * (*attrCount));
//     if (!attrList) return NULL;  
...
//     attrData->value = NULL;
//     attrData->classSym = NULL;
//     attrData->size = *attrCount;  

//     attrList[*attrCount - 1] = attrData; 
//     return attrList;
// }


// Data* createClass(char* name, Data** attrList, int* attrCount) {
//     Data* dta = (Data*)malloc(sizeof(Data));
//     dta->type = CLASS_TYPE;
//     dta->value = (void*)attrList;
...
// // Data** createAttributes(char* attrName,char* className) {
...
// // Data** addAttribute(Data** attrList, char* attrName, char* className) {
...
// //     attrList = (Data**)realloc(attrList, sizeof(Data*) * count);
// //     if (!attrList) return NULL;  
...
// //     attrData->value = NULL;
// //     attrData->classSym = NULL;
// //     attrList[count] = attrData;
// //     sym->data->size +=1;
// //     return attrList;
// // }


// // Data* createClass(char* name, Data** attrList, char* className) {
// //     Data* dta = (Data*)malloc(sizeof(Data));
// //     dta->type = CLASS_TYPE;
// //     dta->value = (void*)attrList;
// //     dta->name = strdup(name);
...
// // Data* createObject(char* className,char* objectName){
// //     Symbol* sym = symbolTable;
// //     Data** classAttributes = NULL;

// //     while(sym){
// //         if ((strcmp(sym->data->name, className) == 0)&& sym->data->type = CLASS_TYPE){
...
//     int attrCount;
//     Data** attributes = createAttributes("attr1", &attrCount);
//     attributes = addAttribute(attributes, "attr2", &attrCount);
//     attributes = addAttribute(attributes, "attr3", &attrCount);

//     createClass("MyClass", attributes,&attrCount);
//     printf("%d \n",attrCount);
//     createClass("MYClass2",attributes,&attrCount);
//     printf("%d \n",attrCount);
